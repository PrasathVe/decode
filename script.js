// ── Loader ──
    ...
    const RESPONSES = [
      ...
      { keywords: ['price', 'pricing', 'cost', 'how much', '$5', 'fee', 'charge'], answer: `The Skill Assessment is just <b>$5</b> — a one-time investment that gives you clarity most people spend years searching for.<br><br><a href='https://topmate.io/decodes/2082631' target='_blank' style='color:var(--olive-glow)'>topmate.io/decodes →</a><br><br><button onclick="restartChat()" class="restart-btn">Restart</button>` },
      ...
      { keywords: ['test', 'tests', 'get', 'access', 'book'], answer: `<b>Skill Assessment:</b><br><a href='https://topmate.io/decodes/2082631' target='_blank' style='color:var(--olive-glow)'>Book Here →</a><br><br><b>QA Consulting:</b><br><a href='https://topmate.io/decodes/2083915' target='_blank' style='color:var(--olive-glow)'>Book Here →</a><br><br><button onclick="restartChat()" class="restart-btn">Restart</button>` },
      { keywords: ['hi', 'hello', 'hey'], answer: `Hey there! 👋<br><br>Ask me about:<br>• Skill Assessment<br>• S.I.G.N.A.L Framework<br>• QA Consulting<br><br><button onclick="restartChat()" class="restart-btn">Restart</button>` }
    ];
